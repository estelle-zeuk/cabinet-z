...
<head>
  ...
  <title>CLATECH Wedding services - {{__('titles.page-not-found')}}</title>
  <!-- plugins:css -->
        ...
        <div class="col-lg-7 mx-auto text-white">
          <div class="row align-items-center d-flex flex-row">
            ...
            <div class="col-lg-6 error-page-divider text-lg-left pl-lg-4">
              <h2>SORRY!</h2>
              <h3 class="font-weight-light">Session has expired. You will have to log in again.</h3>
            </div>
          </div>
          <div class="row mt-5">
            <div class="col-12 text-center mt-xl-2">
              <a class="text-white font-weight-medium" href="{{url('/login')}}">Login</a>
            </div>
          </div>
          <div class="row mt-5">
