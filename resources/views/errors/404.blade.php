...
<!-- Mirrored from templates.hibootstrap.com/opnix/default/404.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Jun 2021 08:48:16 GMT -->
<head>
  <meta charset="UTF-8">
  ...
  <link rel="stylesheet" href="{{asset('frontend/css/datetimepicker.min.css')}}">

  <link rel="stylesheet" href="{{asset('frontend/css/style.css')}}">

  <link rel="stylesheet" href="{{asset('frontend/css/responsive.css')}}">
  <title>Opnix - Optometrist and Eye Care HTML Template</title>
    ...
    <div class="d-table-cell">
      <div class="container">
        <div class="error-content">
          ...
          <h1>Sorry!</h1>
          <h2>{!! __('Une erreur s\'est produite') !!}</h2>
          <p>La page que vous recherchez n'existe pas</p>
          <a class="common-btn" href="{{mob_route('welcome')}}">{!! __('Retour à l\'accueil') !!}</a>
        </div>
      </div>
    </div>
  </div>
