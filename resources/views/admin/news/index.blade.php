...
@section('title', __('menu.news-management'))
                    ...
                    <div class="row grid-margin">
                        <div class="col-12">
                            <div style="text-align: right">
                                <a href="{{mob_route('news.create')}}" class="btn btn-primary btn-fw">{{__('buttons.create')}}</a>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{asset('frontend/images/publications/'.$info->images)}}" alt="profile"/>
                                                <div class="ml-3">
                                                    <p class="mb-2">{{$info->code}}</p>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            ...
                                            <div class="row">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuIconButton1">
                                                         <a href="{{mob_route('news.show',$info->id)}}" class="dropdown-item">
                                                             <i class="icon-eye text-primary"></i> {{__('buttons.preview')}}
                                                         </a>
                                                        <div class="dropdown-divider"></div>
                                                        <a href="{{mob_route('news.edit',$info->id)}}" class="dropdown-item">
                                                            <i class="icon-pencil text-primary"></i> {{__('buttons.edit')}}
                                                        </a>
                                                        <div class="dropdown-divider"></div>
                                                        @if($info->is_published == 0)
                                                            <a href="{{mob_route('news.publish',$info->id)}}" class="dropdown-item">
                                                                <i class="fa fa-eye text-primary"></i> {{__('buttons.publish')}}
                                                            </a>
                                                        @else
                                                            <a href="{{mob_route('news.un.publish',$info->id)}}" class="dropdown-item">
