    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title" style="text-align: center; padding-bottom: 20px;">{{__('Création de Publication')}}</h4>
                        ...
                        @endif
                        {!! Form::open(['route' => 'news.store', 'files'=>true, 'id'=>'claForm', 'class' => 'forms-sample']) !!}
