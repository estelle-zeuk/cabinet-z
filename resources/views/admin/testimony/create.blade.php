...
@section('title', __('labels.testimony.creation'))
@section('css')
    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title" style="text-align: center; padding-bottom: 20px;">{{__('labels.testimony.creation')}}</h4>
                        ...
                        @endif
                        {!! Form::open(['route' => 'testimony.store', 'class' => 'forms-sample','files'=>true]) !!}
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea {{ $errors->has('description') ? 'has-error' : '' }} name="description" id="description" style="width: 100%" required></textarea>
